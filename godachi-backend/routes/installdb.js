...
let settingsData = require("../db.json/godachi.settings.json");

let Users = require("../models/users.model");
let usersData = require("../db.json/godachi.users.json");

let Variants = require("../models/variants.model");
let variantsData = require("../db.json/godachi.variants.json");

let Turkey = require("../models/turkey.model");
let turkeyData = require("../db.json/godachi.turkey.json");

let Topmenu = require("../models/topmenu.model");
let topmenuData = require("../db.json/godachi.topmenu.json");

let Productimages = require("../models/productimages.model");
let productimagesData = require("../db.json/godachi.productimages.json");

let Products = require("../models/products.model");
let productsData = require("../db.json/godachi.products.json");

let Paymentmethods = require("../models/paymentmethods.model");
let paymentmethodsData = require("../db.json/godachi.paymentmethods.json");

let Orderstatus = require("../models/orderstatus.model");
let orderstatusData = require("../db.json/godachi.orderstatus.json");

let Orders = require("../models/orders.model");
let ordersData = require("../db.json/godachi.orders.json");

let Homeslider = require("../models/homeslider.model");
let homesliderData = require("../db.json/godachi.homeslider.json");

let Country = require("../models/country.model");
let countryData = require("../db.json/godachi.country.json");

let Categories = require("../models/categories.model");
let categoriesData = require("../db.json/godachi.categories.json");

let Cargoes = require("../models/cargoes.model");
let cargoesData = require("../db.json/godachi.cargoes.json");

let Brands = require("../models/brands.model");
let brandsData = require("../db.json/godachi.brands.json");
