...
const Default = () => {
  ...
  function getData() {
    axios.get(`${API_URL}/masters/diamondVariants/${id}`).then((response) => {
  ...
  const onSubmit = (Data) => {
    axios
      .post(`${API_URL}/masters/diamondVariants/${id}`, Data)
      .then((res) => {
        if (res.data.variant == "error") {
          ...
          router.push("/masters/diamond/list");
        }
      })
  ...
  return (
    <div>
      <Card className="card" title="Edit Diamond Property">
        <Form
          {...formItemLayout}
          form={form}
          name="add"
