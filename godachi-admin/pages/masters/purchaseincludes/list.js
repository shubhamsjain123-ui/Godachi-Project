...
const Default = () => {
    ...
    },
    {
      ...
      render: (text, record) => (
        <span className="link ant-dropdown-link">          
          {role["masters/id"] ? (
            <Link href={"/masters/purchaseincludes/" + record._id}>
              <a>
                {" "}
                <EditOutlined
  ...
  const deleteData = (id) => {
    axios.delete(`${API_URL}/masters/purchaseincludes/${id}`).then(() => {
  ...
  return (
    <div>
      {role["masters/add"] ? (
        <Link href="/masters/purchaseincludes/add">
          <Button
            type="primary"
